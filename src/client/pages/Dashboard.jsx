...
const Dashboard = () => {
  ...
  const services = [
    ...
    },
    {
      name: "Eye Check Up",
      description:
        "Eye checkups are specialized evaluations focused on assessing vision and detecting eye-related issues, such as refractive errors or diseases like glaucoma. These examinations include vision tests, eye pressure checks, and consultations to ensure optimal eye health and corrective solutions if necessary.",
      image: chat,
    },
    {
    ...
    },
    {
      ...
      description:
        "Xray checkups are diagnostic imaging procedures that provide detailed views of bones and internal organs to detect injuries, fractures, or underlying health conditions. This non-invasive process aids in accurate diagnosis and treatment planning for a wide range of medical concerns.",
      image: chat,
    },
    {
  ...
  // Filter events to show only today's and upcoming events
  const filteredEvents = events.filter((event) => {
    const eventDate = new Date(event.date_time);
    return eventDate >= new Date(); // Only show today's or future events
  });

  // Filter events for the selected date
  const filteredEventsForDate = filteredEvents.filter((event) => {
    const eventDate = new Date(event.date_time);

    // Normalize both event date and selected date to midnight to ignore time differences
          ...
          <div className="services-grid">
            ...
            <div className="rectangle23 paalala1">
              ...
              <p>
                ...
                (Wednesday) simula 8AM-6PM lamang. <br />
                <br />
      ...
      <section className="events-section">
        ...
        <div className="events-container">
          ...
          <div className="events-list">
            <h3>Upcoming Events on {date.toDateString()}</h3>
      ...
      <section className="barangay-officials-section">
        ...
        <div className="officials-grid">
          {[{ name: "Ferrer, Rizalino", position: "Punong Barangay" },
            ...
            { name: "Colibao, Shennel", position: "Kagawad" }].map((official, index) => (
